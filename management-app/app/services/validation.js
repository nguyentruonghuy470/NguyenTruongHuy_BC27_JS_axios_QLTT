...
const accountCheckAdd = (taiKhoan) => {
  const isAccountExist = usersData.some((user) => user.taiKhoan === taiKhoan);
  if (!isRequired(taiKhoan)) {
    accountInput.nextElementSibling.innerHTML = 'Tài khoản không được để trống';
    return false;
...
export const checkValidation = (
  ...
  let accountIsValid;
  if (action === 'add') {
    accountIsValid = accountCheckAdd(taiKhoan);
